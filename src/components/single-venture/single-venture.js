...
export default function SingleVentureInnerDivHeader({ Icon, title, description, badgeLabel, containerClassName }) {
    return (
            ...
            <div className="flex justify-between items-center md:items-start mb-2 md:mb-6">
                <div className="flex items-center md:items-start gap-4 w-full">
                    ...
                    <div className='flex-1'>
                        ...
                        <p className="text-text-gray text-sm mt-0.5 hidden md:block">{description}</p>
                    </div>
                </div>
