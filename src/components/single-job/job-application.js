    ...
    <div className={"flex-1 flex flex-col gap-4"}>
      ...
      <Wrapper>
        <div className="mx-auto">
          ...
          <div className="mb-6">
            <h1 className="mb-3 text-2xl 2xl:text-3xl font-bold text-gray-900">
              Senior/Staff Code Review Experts
            </h1>
            <div className="flex gap-2">
              <span className="inline-flex items-center gap-1 rounded-full border border-secondary text-text-gray bg-white px-3 py-1 text-sm text-gray-700">
          ...
          <div className="mb-8 flex items-center justify-between">
            ...
            <button className="text-xs font-medium py-1 px-3 rounded-full bg-green-100 text-green-600 hover:text-green-700">
              Open to applications
            </button>
          </div>

          {/* Application progress card */}
          <div className="mb-8 rounded-lg lg:rounded-2xl bg-bg-gray p-6">
