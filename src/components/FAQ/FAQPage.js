  ...
  return (
    <Wrapper className="shadow-[#00000025]">
      ...
      <div className="flex justify-end gap-4">
        {/* <button className="px-6 py-2 rounded-full border border-[#87CEEB] text-[#87CEEB] font-medium hover:bg-gray-50 transition-colors">
          Back
        </button> */}
        <BorderButton size="md" className="flex items-center gap-2 w-fit px-4 !py-1.5">
          Back
        </BorderButton>
        {/* <button className="px-6 py-2 rounded-full bg-[#304E77] text-white font-medium hover:bg-[#304E77]/90 transition-colors shadow-lg">
          Save & continue
        </button> */}
        <Button size="md" className="flex items-center gap-2 w-fit px-4 !py-1.5">
          Save & continue
