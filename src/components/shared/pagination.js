...
// const sizeClasses = {
//   xs: {
//     container: "gap-0.5 sm:gap-1 md:gap-1.5 lg:gap-2",
//     button:
//       "h-6 w-6 text-[10px] \
...
//   sm: {
//     container: "gap-1 sm:gap-1.5 md:gap-2 lg:gap-2.5",
//     button:
//       "h-7 w-7 text-xs \
...
//   md: {
//     container: "gap-1.5 sm:gap-2 md:gap-2.5 lg:gap-3",
//     button:
//       "h-8 w-8 text-sm \
...
//   lg: {
//     container: "gap-2 sm:gap-2.5 md:gap-3 lg:gap-3.5",
//     button:
//       "h-9 w-9 text-base \
...
//   xl: {
//     container: "gap-2.5 sm:gap-3 md:gap-3.5 lg:gap-4",
//     button:
//       "h-10 w-10 text-lg \
...
//     <div
//       className={cn(
//         `flex flex-1 items-center justify-center ${classes.container}`,
//         containerClassName
//       )}
//     >
//       {previous}
